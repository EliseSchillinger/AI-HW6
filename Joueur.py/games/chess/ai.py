...
class AI(BaseAI):
    ...
    def make_move(self) -> str:
        ...
        for k in max_depth: # iterate until max depth
            moves = chess_game_logic.max_choice(fen_string, k, last_8_moves) # action is the move, takes the state (fen) and current depth
            print(moves)
        return moves
